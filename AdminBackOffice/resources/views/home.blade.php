    ...
    <div class="card">
        <div class="card-body">
            <div class="jumbotron bg-transparent m-0">
                ...
                <p class="lead">You are on the administration platform of the Atlantis project.<br/>This platform aims
                    to list the IoT devices associated with users of the mobile application.</p>
                <hr class="my-4">
